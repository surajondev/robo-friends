This repositroy is using react to develop app that has list of robots that can be searched. Click Here to see the website [Robo-Friends](https://surajondev.github.io/robo-friends/)
